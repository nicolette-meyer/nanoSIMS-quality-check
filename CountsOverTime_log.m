...
% number). The y axis scale is log base 10.
%
% USAGE:
%       figh = CountsOverTime_log( majorisotope, minorisotope, isotope )
%
% INPUTS:
...
function [figh] = CountsOverTime_log( majorisotope, minorisotope, isotope )
...
%Log scale
   semilogy(SumMajorCounts);
   hold on;
   semilogy(SumMinorCounts);
